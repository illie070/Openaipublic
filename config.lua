...
Config.WeaponCategoryOffsets = {
	...
	{category = 'frontrifle', bone = 24818, x = 0.01, y = 0.22, z = 0.1, xRot = 200.0, yRot = 170.0, zRot = 10.0},
...
Config.ShowWeapons = {
	...
	{name = 'WEAPON_CROWBAR', 			category = 'utilitymelee', 	model = 'w_me_crowbar', canHide = true},
